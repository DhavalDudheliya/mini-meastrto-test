...
const HappyFamilies = () => {
  ...
  return (
    <section className="bg-[#5AD6FC1A] rounded-3xl p-6 md:p-10 mx-4 my-8 shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
      {/* Heading */}
      ...
      <div className="grid gap-6 md:grid-cols-3 max-w-7xl mx-auto">
        {testimonials.map((testimonial, idx) => (
          <div key={idx} className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-start">
            {/* Avatar & Name */}
            <div className="flex items-center mb-4">
              <Image src={testimonial.image} alt={testimonial.name} width={40} height={40} className="rounded-full mr-3 object-cover h-10 w-10" />
              <div>
